...
class EasyCRUD
{
    ...
    {
        $this->attributes[$this->pk] = (empty($this->attributes[$this->pk])) ? $id : $this->attributes[$this->pk];
        ...
        if (count($columns) > 1) {
            ...
            if ($id === '0' && $this->attributes[$this->pk] === '0') {
    ...
    {
        $id = (empty($this->attributes[$this->pk])) ? $id : $this->attributes[$this->pk];
    ...
    public function find($id = '')
    {
        ...
        if (!empty($id)) {
            ...
            $this->attributes = ($result != false) ? $result : null;
        }
    }
    ...
    {
        $bindings = empty($fields) ? $this->attributes : $fields;
    ...
    private function exec($sql, $array = null)
    {
        ...
        if ($array !== null) {
            ...
            // Get result with the DB object
            $result = $this->db->query($sql, $this->attributes);
        }
